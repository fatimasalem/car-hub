            ...
            <Dialog as='div' className="relative z-10" onClose={closeModel}>
                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    <div className='flex min-h-full items-center justify-center p-4 text-center'>
                        ...
                        >
                            <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl text-left bg-white shadow-2xl transition-all flex flex-col gap-5 p-6">
                                <button
                                    type='button'
                                ...
                                <div className='flex-1 flex flex-col gap-3'>
                                    ...
                                    <div className='flex gap-3 '>
                                        ...
                                        <div className='flex-1 relative w-full h-24 mt-4 bg-primary-blue-100 rounded-lg'>
